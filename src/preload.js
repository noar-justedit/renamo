...
contextBridge.exposeInMainWorld('renamo', {
  ...
  scanLeftovers: (dir) => ipcRenderer.invoke('scan-leftovers', dir),
  recoverLeftovers: (dir) => ipcRenderer.invoke('recover-leftovers', dir),
  unfinishedBatch: () => ipcRenderer.invoke('unfinished-batch'),
